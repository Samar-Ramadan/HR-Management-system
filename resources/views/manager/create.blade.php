      ...
      <div class="login-box">
        ...
        >
         ...
         @enderror
          ...
          <div class="user-box">
            <input type="string" name="name_company" class =" @error ('name_company') is-invalid @enderror" >
            @error ('name_company')

            <div class=" alert alert-danger"> {{$message}}</div>
         @enderror
            <label>name_company</label>
          </div>
         ...
         @enderror
          ...
          <div class="user-box">
            <input class="password" type="password" name="password" for="password" class =" @error ('password') is-invalid @enderror">
            @error ('password')
