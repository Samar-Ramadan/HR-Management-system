  ...
  <body>
    ...
    <nav class="nav">
      ...
      <ul>
        ...
        <li>
        <a href="{{route('jop.index')}}" class="" id="">Jops</a>
          
        </li>

        <li>
          <a href="{{route('report.index')}}" class="" id="">Report</a>
            
          </li>
          <li>
            <a href="bonusescreate" class="" id="">Bonuses</a>
              
            </li>
          <li>
            <a href="{{route('requests.index')}}" class="" id="">Request</a>
